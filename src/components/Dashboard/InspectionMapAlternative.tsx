...
export function InspectionMapAlternative({ 
  inspections, 
  height = 400,
  isLoading = false
}: InspectionMapProps) {
  ...
  // Corrigir o problema com os ícones do Leaflet de forma alternativa
  // Esta abordagem não depende da importação direta das imagens
  useEffect(() => {
